        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-24">
          ...
          <div className="mb-8">
            ...
            <div className="flex flex-col sm:flex-row gap-4 justify-center">
              <Link
                href="/about"
                className="bg-yellow-400 hover:bg-yellow-500 text-red-900 font-bold py-3 px-8 rounded-lg transition-colors shadow-lg"
              >
                Learn More About Me
              </Link>
              <Link
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16">
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
          ...
          <div className="bg-white/10 backdrop-blur-sm rounded-xl p-6 border border-yellow-400/20 hover:border-yellow-400/40 transition-all">
            ...
            <p className="text-red-100 mb-2">Bachelor of Science in Computer Science</p>
          ...
          <div className="bg-white/10 backdrop-blur-sm rounded-xl p-6 border border-yellow-400/20 hover:border-yellow-400/40 transition-all">
            ...
            <div className="space-y-2">
              <div className="flex justify-between">
                <span className="text-red-100">JavaScript</span>
                <span className="text-yellow-400">85%</span>
              </div>
              <div className="flex justify-between">
                <span className="text-red-100">Python</span>
                <span className="text-yellow-400">80%</span>
              </div>
              <div className="flex justify-between">
                <span className="text-red-100">React</span>
